...
{
public: 
   void code_string_table(ostream&);
};
...
class FloatTable : public StringTable<FloatEntry>
{
public:
   void code_string_table(ostream&);
};
